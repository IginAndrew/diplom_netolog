...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/andrew/Yandex.Disk/Andrew/diplom_netolog/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/home/andrew/Yandex.Disk/Andrew/diplom_netolog/venv/bin/deactivate.nu'
